...
private fun showDoctorsContextCreate() {
  contextCreate(ShowDoctors.path, ShowDoctors.lambda)
}

private fun showPatientsContextCreate() {
  contextCreate(ShowPatients.path, ShowPatients.lambda)
}

private fun showStatusesContextCreate() {
  contextCreate(ShowStatuses.path, ShowStatuses.lambda)
}

private fun showSpecialisationsContextCreate() {
  contextCreate(ShowSpecialisations.path, ShowSpecialisations.lambda)
}

private fun showServicesContextCreate() {
  contextCreate(ShowServices.path, ShowServices.lambda)
}
...
private fun createContexts() {
  ...
  showDoctorsContextCreate()
  showPatientsContextCreate()
  showStatusesContextCreate()
  showSpecialisationsContextCreate()
  showServicesContextCreate()
}
